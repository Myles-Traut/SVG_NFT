...
.PHONY: all test clean deploy fund help install snapshot format anvil zktest deployMood flipMood
...
flipMood:
	@forge script script/FlipMood.s.sol:FlipMood $(NETWORK_ARGS)
